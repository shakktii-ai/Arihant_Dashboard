  ...
  useEffect(() => {
    const checkAttempts = async () => {
      ...
      try {
        ...
        const data = await res.json();
        if (data.ok) setAttemptInfo(data);
      } catch (e) {
        console.error("Error checking attempts:", e);
      } finally {
        setCheckingAttempts(false);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="py-8 flex justify-center">
        <img
          src={jobInfo?.companyLogo || "/MM_LOGO.png"}
          alt="Company Logo"
      ...
      <div className="flex-grow flex items-center justify-center px-4 pb-16">
        <div className="w-full max-w-xl bg-white shadow-xl rounded-2xl p-8 md:p-10">
          ...
          <h1 className="text-2xl md:text-3xl font-semibold text-gray-900 text-center">
            {jobInfo ? `Apply for ${jobInfo.jobRole}` : "Apply for Interview"}
          </h1>
            ...
            <div>
              ...
              {attemptInfo &&
                ...
                attemptInfo.remainingAttempts === 0 && (
                  <div className="mt-3 p-4 rounded-xl border bg-red-50 border-red-200">
                    <p className="text-sm font-medium text-red-700">
                      Maximum attempts reached
                    </p>
                    <p className="text-xs text-gray-600 mt-1">
