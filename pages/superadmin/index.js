                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg transition ${company.onboardingCompleted
              ...
              <>
                ...
                <div className="flex justify-between">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold transition shadow-md"
                  >
                    Add Live Credits
                  </button>
                </div>
            ...
            <div className="overflow-y-auto px-8 py-6 space-y-8">
              ...
              <div className="pt-4">
                ...
                >
                  ...
                  View All Payment Receipts (Invoices)
                </button>
              </div>
